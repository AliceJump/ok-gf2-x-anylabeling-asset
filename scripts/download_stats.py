...
repo_full = os.getenv("GITHUB_REPOSITORY", "AliceJump/ok-gf2-x-anylabeling-asset")

if "/" in repo_full:
    OWNER, REPO = repo_full.split("/", 1)
else:
    OWNER = "AliceJump"
    REPO = "ok-gf2-x-anylabeling-asset"
...
HEADERS = {
    ...
    "User-Agent": "ok-gf2-x-anylabeling-asset-download-stats",
}
